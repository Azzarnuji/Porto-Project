...
function Portofolio() {
    ...
    useEffect(() => {
        if (scrollPosition > getSectionPosisition?.sectionOne.positionY && scrollPosition <= getSectionPosisition?.sectionTwo.positionY) {
            setActiveClass({
                about: true,
                experience: false,
                projects: false
            });
        } else if (scrollPosition > getSectionPosisition?.sectionTwo.positionY && scrollPosition < getSectionPosisition?.sectionThree.positionY) {
            setActiveClass({
                about: false,
                experience: true,
                projects: false
    ...
    return (
        <>
            <div className="bg-slate-900 text-slate-300">
                ...
                <div className="container mx-auto w-screen font-sans" onMouseMove={(e) => setPointer({ pointerX: e.clientX, pointerY: e.clientY })}>
